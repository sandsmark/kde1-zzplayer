...
CONFIG_CLEAN_FILES =  zzplayer.spec
...
install-sh ltconfig ltmain.sh missing mkinstalldirs zzplayer.spec.in
...
zzplayer.spec: $(top_builddir)/config.status zzplayer.spec.in
